...
public class MixinConflictHelper implements PreLaunchEntrypoint {
    ...
    public static String makeIssueTemplate(Mod mod1, Mod mod2, String stacktrace) {
        var modListBuilder = new StringBuilder();
        ...
        return """
                ...
                mod1.name(), mod1.sourcesUrl().orElse("#"),
                mod2.name(), mod2.sourcesUrl().orElse("#"),
                stacktrace,
                modListBuilder.toString(),
                FabricLoader.getInstance().getModContainer("minecraft").orElseThrow().getMetadata().getVersion().getFriendlyString(),
                FabricLoader.getInstance().getModContainer("fabricloader").orElseThrow().getMetadata().getName(),
                FabricLoader.getInstance().getModContainer("fabricloader").orElseThrow().getMetadata().getVersion()
        );
    }
}
